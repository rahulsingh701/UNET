...
# Change the path for the following directory below for your own dataset.
...
def train_net(net,
    ...
    for epoch in range(epochs):
        ...
        if (epoch%2 == 0):
            ...
            torch.save(net.state_dict(), str(dir_checkpoint / f'checkpoint_epoch_{epoch + 1}.pth'))
...
# Change the n_channels depening on your input image channel
# Change the n_classes paramter depending on the number of classes. 
# Note background is considered as a class hence 2 classes present here.
    ...
    try:
        ...
        torch.save(net.state_dict(), 'INTERRUPTED_TRAINING.pth')
        logging.info('Saved Training interrupt')
        sys.exit(0)
